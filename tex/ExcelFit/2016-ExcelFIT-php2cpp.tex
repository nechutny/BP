...
\label{sec:Conclusions}
	...
	Jsou dostupné zdrojové kódy pod open source licencí \todo{vyřešit licenci - nejspíš Apache-2.0} umožňující vyzkoušet si překlad a v~případě úspěchu nasadit, či se zapojit do vývoje.
