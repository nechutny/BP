...
\projectinfo{
  ...
  acknowledgment={Dìkuji svému vedoucímu panu doktoru Køivkovi za nasmìrování správným smìrem a doporuèení literatury. Dále pak Bc. Marku Milkovièi, za konzultace k~jazyku C++ a analýze zdrojových kódù a panu Edsko de Vries za poskytnutí cených podkladù.} % nepovinne
}
