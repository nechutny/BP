...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={PHP, C++, C++1, pøeklad, modul, roz¹íøení, optimalizace, PHP-CPP, xdebug, datové typy, analýza kódu, PHC, HPHPc, HHVM, Testy øízené programování, generování kódu, tokeny, výrazy, precedenèní analýza, konverze datových typù, transformace}, %klicova slova v ceskem jazyce
  ...
  acknowledgment={Dìkuji svému vedoucímu panu doktoru Køivkovi za nasmìrování správným smìrem a doporuèení literatury. Dále pak Bc. Marku Milkovièovi, za konzultace k jazyku C++ a analýze zdrojových kódù.} % nepovinne
}
