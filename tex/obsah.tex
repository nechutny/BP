...
\chapter{Konkurenèní øe¹ení}
	...
	\section{phc}
		...
		Pøi analýze tohoto øe¹ení jsem se rozhodl kontaktovat vývojáøe a provést s~nimi krátký rozhovor, v~kterém bych rád zjistil odpovìdi na nìkolik otázek. Zamý¹lel jsem zjistit v~jakém stavu se tento projekt nachází, jaké byly plány do budoucna a proè do¹lo k~jeho pozastavení. Dále mne zajímalo, zda i dnes pova¾uje zainteresovaná osoba tento koncept za prakticky pou¾itelný a jaké by mohli být pøeká¾ky. Kontaktoval jsem postupnì 3 bývalé vývojáøe tohoto projektu, ale bohu¾el se mi nepodaøilo získat odpovìdi. Poslední kontaktovaný pøislíbil odpovìdi, ale e-mail s~dotazy ji¾ zùstal bez reakce.
