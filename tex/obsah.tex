...
\end{lstlisting}
	...
	Dal¹í implementovanou èástí je podpora konstrukcí \function{echo}, \function{list}, \function{exit} a dal¹í uvedené v~tabulce \ref{table:phpTokenConstruction}.
		...
		TODO: Rozpsat jak magická jména promìnných (ne)budou podporována (napøíklad v PHP lze zapsat \fucntion{\$\$a}, kdy se pou¾ije honota promìnné \function{\$a} jako název promìnné - nebude zøejmì podporováno, jeliko¾ není èasté a jedná se o potencinální zanesení chyb)
