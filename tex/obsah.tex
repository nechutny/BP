...
\end{lstlisting}
		...
		\subsection{Reálné aplikace}

			\subsubsection{Nette Framework}

				\todo[inline]{???}

			\subsubsection{Nìjaká stará PHP 4 knihovna}
				\todo[inline]{...}

			\subsubsection{...}
				\todo[inline]{Prohledat staré projekty}
...
\chapter{Závìr}
	...
	Souèasný stav ov¹em plánuji zmìnit, jeliko¾ nástroj vzniklý v rámci této práce hodlám zveøejnit zdarma jako open source projekt pod licencí Apache 2.0 s placenou technickou podporou. V dobì dokonèování této práce je ji¾ na adrese \url{www.php2cpp.net} rozpracovaný web pro prezentaci øe¹ení. Zájem o tento nátroj projevilo hned nìkolik zástupcù firem na studentské konferenci Excel@FIT, na které jsem demonstroval své øe¹ení. Výsledek má tedy komerèní potenciál. V blízké dobì mám v úmyslu zlep¹it detekci datových typù za pou¾ití postupù navr¾ených v této práci a dokonèit novou implementaci tøídy pro dynamické datové typy. Zamý¹lím také prezentovat toto øe¹ení na dal¹ích konferencích zamìøených na PHP vývojáøe. Jednou z takových akcí je PoSobota, na které se neformálnì scházejí vývojáøi, nejen pou¾ívající Nette Framework, a pøedná¹ejí o zajímavých technických øe¹eních.
